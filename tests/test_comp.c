...
//     create_frequencies(cpy_frequencies);
...
//     BTree tree1 = btree_join(freq1, NULL, NULL);
//     BTree tree2 = btree_join(freq2, NULL, NULL);
...
//     tmp = btree_join(copy_charfreq(frequencies[3]), NULL, NULL);
//     test_list = sglist_insert(test_list, tmp, id, (CompareFunction)compare_nodes_freq);

//     tmp = btree_join(copy_charfreq(frequencies[1]), NULL, NULL);
//     test_list = sglist_insert(test_list, tmp, id, (CompareFunction)compare_nodes_freq);

//     tmp = btree_join(copy_charfreq(frequencies[0]), NULL, NULL);
//     test_list = sglist_insert(test_list, tmp, id, (CompareFunction)compare_nodes_freq);

//     tmp = btree_join(copy_charfreq(frequencies[2]), NULL, NULL);
//     test_list = sglist_insert(test_list, tmp, id, (CompareFunction)compare_nodes_freq);
